...
The community candidate uses `0.7.0-alpha.1` for release artifacts and the PEP 440 equivalent
`0.7.0a1` for the Python package. `VERSION`, `CHANGELOG.md`, `pyproject.toml`, the web package,
