...
**Current decision: GO for the scoped community alpha.** Pull requests #38 and #55 are merged, the
static gallery is deployed, all mandatory hosted and owner-controlled gates are recorded below,
and the two SHA-tagged container artifacts have SBOM and signed provenance evidence. This decision
covers public source review, contribution, the synthetic CSV path, and the network-disabled Pages
gallery. It does not approve an Internet-facing runtime, production data, or a production SLA.

## Candidate identity

- Version: `0.7.0-alpha.1` (`0.7.0a1` for Python)
- Baseline: `eaf7f5be3b45042ae786a8cf5837d6cc53af8122`
- Release source SHA: `a31848bf5262c03c4fe3bb5a9d2b293a01682e9b`
...
| 2 | CI and supported runtimes | Implemented | Exact-SHA Python 3.11–3.13, PostgreSQL, web, container, CodeQL, and security runs passed; 123 web tests passed with greater than 97% line and branch coverage |
...
| 4 | Visualization scope | 44 targets, 76 product types, eight batches | Hosted accessible-tree and keyboard review found 15 named chart images and 61 queued cards with selected-button state, live result announcements, and no desktop overflow |
...
- [x] Candidate branches existed remotely and pull requests #38 and #55 were reviewed and merged to `main`.
...
runtime deployment. The public prerelease tag must target the exact release source SHA above.
